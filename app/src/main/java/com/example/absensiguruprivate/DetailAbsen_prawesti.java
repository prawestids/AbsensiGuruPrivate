...
public class DetailAbsen_prawesti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_absen_prawesti);
        ...
        Call<List<GuruItem_prawesti>> call = apiInterface.getGuruByUsername(getIntent().getStringExtra("username"));
        ...
        Call<List<AbsensiItem_prawesti>> call1 = apiInterface.getAbsenByUsername(getIntent().getStringExtra("username"));
    ...
    public void onClickLogout(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(DetailAbsen_prawesti.this);
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<ResponseBody> call = apiInterface.absenGuru(new AbsensiItem_prawesti(username, password, jam_login, jam_logout, tanggal, lokasi_latitude, lokasi_longitude, nim_siswa, nama_siswa, alamat));
