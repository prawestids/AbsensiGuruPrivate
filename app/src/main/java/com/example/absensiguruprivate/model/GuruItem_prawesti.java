...
public class GuruItem_prawesti extends AbstractItem<GuruItem_prawesti, GuruItem_prawesti.ViewHolder> {
    ...
    public GuruItem_prawesti(String id_guru, String nama, String alamat, String jenis_kelamin, String no_telp, String foto, String username, String password) {
    ...
    @NonNull
    @Override
    public GuruItem_prawesti.ViewHolder getViewHolder(View v) {
    ...
    public int getLayoutRes() {
        return R.layout.item_guru_prawesti;
    }

    public class ViewHolder extends FastAdapter.ViewHolder<GuruItem_prawesti> {
        ImageView profil;
        ...
        @Override
        public void bindView(GuruItem_prawesti item, List<Object> payloads) {
        ...
        @Override
        public void unbindView(GuruItem_prawesti item) {
